...
from PyQt5.QtWidgets import QApplication, QDialog, QTableWidget, QVBoxLayout, QPushButton
from PyQt5.QtWidgets import QHBoxLayout, QMessageBox, QTableWidgetItem, QDialogButtonBox 
...
class calibrationDialog(QDialog):
    ...
    def __init__(self, peaks = testnaTabela, fname=home, parent = None):
        ...
        pbDeleteRow.clicked.connect(self.remove)
        self.pbFillFromRedLine.clicked.connect(self.fill)
        buttonBox.button(QDialogButtonBox.Apply).cliced.connect(self.apply)
        buttonBox.rejected.connect(self.reject)
        pbSave.clicked.connect(self.saveToFile)
        pbLoad.clicked.connect(self.loadFromFile)
