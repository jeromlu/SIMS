...
from PyQt4.QtGui import QApplication, QDialog, QGridLayout, QTabWidget, QWidget
from PyQt4.QtGui import QLabel, QLineEdit,QVBoxLayout, QHBoxLayout, QBoxLayout, QCheckBox
from PyQt4.QtGui import QDialogButtonBox, QPushButton, QFileDialog
...
class Form(QDialog):
    ...
    def __init__(self, properties, parent= None):
        ...
        self.connect(pbBaseFolder,SIGNAL("clicked()"),self.getBaseFolder)        
